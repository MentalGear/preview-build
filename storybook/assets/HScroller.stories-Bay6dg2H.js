...
directly.`,keywords:[],kind:"let",type:{kind:"function",text:"(state: { scrollLeft: number; trackWidth: number; scrollWidth: number; }) => void"},static:!1,readonly:!1}],name:"HScroller.svelte"};const{expect:a,userEvent:Q,waitFor:p}=__STORYBOOK_MODULE_TEST__,b=W=>{var l=qe();I(l,"display:flex; gap:8px; padding:0.5rem; width:1372px;"),ie(l,20,()=>ce,_=>_,(_,C)=>{var k=Ke(),m=h(k);Z(()=>{I(k,`flex:0 0 90px; height:64px; border-radius:8px; border:1px solid var(--border); background:hsl(${C*47%360} 70% 55%); color:#fff; font-weight:600;`),le(m,C)}),i(_,k)}),i(W,l)},we=W=>{var l=Me();I(l,"display:flex; gap:8px; padding:0.5rem; width:1372px;"),ie(l,20,()=>ce,_=>_,(_,C)=>{var k=Ie();k.__mousedown=$=>$.preventDefault();var m=h(k);Z(()=>{I(k,`flex:0 0 90px; height:64px; border-radius:8px; border:1px solid var(--border); background:hsl(${C*47%360} 70% 55%); color:#fff; font-weight:600;`),le(m,C)}),i(_,k)}),i(W,l)},Pe=W=>{var l=Re();i(W,l)},Fe=90,Ee=8,ke=14,Oe=Fe+Ee,g=ke*Oe,ce=Array.from({length:ke},(W,l)=>l),De={title:"Composites/HScroller",component:v,tags:["autodocs"],parameters:{a11y:{context:{exclude:[[".demo-chip"]]}}}},{Story:y}=Te();var Ke=c('<button type="button" class="demo-chip"> </button>'),qe=c("<div></div>"),Ie=c('<button type="button" class="demo-chip" tabindex="-1"> </button>'),Me=c("<div></div>"),Re=c('<div style="padding:0.5rem;">(nothing to scroll)</div>'),Ye=c('<div style="max-width:420px;"><!></div>'),je=c('<div style="max-width:420px;"><!></div>'),ze=c('<div style="max-width:420px;"><!></div>'),Ge=c('<div style="max-width:420px;"><!></div>'),Xe=c('<button type="button" class="demo-chip"> </button>'),Ve=c('<div><input class="demo-input" aria-label="Demo text field" style="flex:0 0 160px; height:40px;"/> <!></div>'),Ue=c('<div style="max-width:420px;"><!></div>'),Je=c('<div style="max-width:420px;"><!></div>'),Qe=c('<div style="max-width:420px;"><!></div>'),Ze=c('<div style="max-width:420px;"><!></div>'),et=c('<div style="max-width:420px;"><!></div>'),tt=c('<div style="max-width:420px;"><!></div>'),rt=c('<div style="max-width:420px;"><!></div>'),at=c('<div style="max-width:420px;"><!></div>'),ot=c('<div style="max-width:420px;"><!></div>'),nt=c('<div style="max-width:420px;"><button type="button" data-testid="scrollkey-toggle">toggle mount</button> <!></div>'),st=c('<div style="max-width:420px;"><!></div>'),lt=c('<div style="max-width:420px;"><!></div>'),it=c('<div style="max-width:420px;"><!></div>'),ct=c('<div style="max-width:420px;"><!></div>'),dt=c("<!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!>  <!> <!> <!> <!> <!> <!>",1);function xe(W,l){me(l,!0);let _=O(!0);var C=dt(),k=_e(C);y(k,{name:"Default",asChild:!0,children:(r,t)=>{var e=Ye(),o=h(e);v(o,{get content(){return b},contentWidth:g,ariaLabel:"Demo strip"}),i(r,e)},$$slots:{default:!0},parameters:{docs:{description:{story:"Default: fades + arrows appear only where there's off-screen content."}},__svelteCsf:{rawCode:`<div style="max-width:420px;">
...
</div>`}}});var H=u(d,2);y(H,{name:"Arrow keys inside a nested input are not hijacked",asChild:!0,play:async({canvasElement:r})=>{const t=r.querySelector(".hs-track"),e=r.querySelector(".demo-input");if(await a(t).not.toBeNull(),await a(e).not.toBeNull(),!t||!e)return;e.focus(),await a(document.activeElement).toBe(e),await Q.type(e,"hello"),e.setSelectionRange(0,0);const o=t.scrollLeft;await Q.keyboard("{ArrowRight}"),await p(async()=>{await a(e.selectionStart).toBe(1)}),await a(t.scrollLeft).toBe(o)},children:(r,t)=>{var e=Ue(),o=h(e);v(o,{ariaLabel:"Nested-input demo",content:K=>{var A=Ve();I(A,"display:flex; gap:8px; padding:0.5rem; width:1372px;");var re=u(h(A),2);ie(re,16,()=>ce,X=>X,(X,V)=>{var U=Xe(),S=h(U);Z(()=>{I(U,`flex:0 0 90px; height:64px; border-radius:8px; border:1px solid var(--border); background:hsl(${V*47%360} 70% 55%); color:#fff; font-weight:600;`),le(S,V)}),i(X,U)}),i(K,A)},$$slots:{content:!0}}),i(r,e)},$$slots:{default:!0},parameters:{docs:{description:{story:`Regression test: a text input nested inside the track must keep its OWN ArrowLeft/
...
</div>`}}});var M=u(B,2);y(M,{name:"Arrow click paging clamps at content end (no overscroll)",asChild:!0,play:async({canvasElement:r})=>{const t=r.querySelector(".hs-track");if(await a(t).not.toBeNull(),!t)return;const e=t.scrollWidth-t.clientWidth;t.scrollLeft=e-40;let o=null;await p(async()=>{o=r.querySelector(".hs-arrow.next"),await a(o).not.toBeNull()}),o.click(),await p(async()=>{await a(t.scrollLeft).toBe(e)})},children:(r,t)=>{var e=Qe(),o=h(e);v(o,{get content(){return b},contentWidth:g,ariaLabel:"Arrow click clamp demo (end)"}),i(r,e)},$$slots:{default:!0},parameters:{docs:{description:{story:`Regression test: a page must never request more than what's actually left to
