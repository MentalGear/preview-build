import{p as k,f as c,a as E,n as q,h as u,b as l,s as b,c as K,t as N,i as M}from"./iframe-Cp5EZZDQ.js";import{c as R,d as I}from"./create-runtime-stories-DlWd_JCy.js";import{V as v}from"./VirtualGrid-D1QPe7XV.js";import{s as G}from"./attributes-DaXk2Qm-.js";import{i as V}from"./lifecycle-DHMvS8D3.js";import"./preload-helper-PPVm8Dsz.js";import"./this-DDpeXo7Z.js";import"./scrollMemory-qOkQMXt7.js";import"./shadcn-utils-KrE3H22K.js";import"./reducedMotion.svelte-Bslp-IUh.js";const{expect:r,userEvent:n,waitFor:J,within:S,fn:P}=__STORYBOOK_MODULE_TEST__,g=(h,i=q,s=q)=>{var o=W(),y=u(o);N(()=>{G(o,`width:100%;height:100%;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:600;background:hsl(${i().hue??""} 70% 55%)`),M(y,s())}),l(h,o)},x=120,A=20,p=Array.from({length:x},(h,i)=>({id:i,hue:i*47%360})),m=Array.from({length:Math.ceil(x/A)},(h,i)=>{const s=i*A,o=Math.min(s+A,x);return{key:`s${i}`,title:`Section ${i+1}`,subtitle:`${o-s} items`,startIndex:s,endIndex:o,count:o-s}}),$=P(),H={title:"Composites/VirtualGrid",component:v,tags:["autodocs"],parameters:{layout:"fullscreen",a11y:{context:{exclude:[[".tile"]]}},docs:{description:{component:""}}}},{Story:f}=I();var W=c("<div> </div>"),F=c('<div style="height:560px;"><!></div>'),D=c('<div style="height:560px;"><!></div>'),j=c('<div style="height:560px;"><!></div>'),U=c('<div style="height:560px;"><!></div>'),Y=c('<div style="height:560px;"><!></div>'),z=c("<!> <!> <!> <!> <!>",1);function O(h,i){k(i,!1),V();var s=z(),o=E(s);f(o,{name:"Justified",asChild:!0,children:(t,d)=>{var e=F(),a=u(e);v(a,{get items(){return p},get sections(){return m},get tile(){return g},ariaLabel:"Justified demo grid",aspect:_=>1+_.id%3*.4}),l(t,e)},$$slots:{default:!0},parameters:{docs:{description:{story:"The grid fills its parent (height:100%), so stories give it a fixed-height box.\n`aspect` varies cell width in the justified layout; `square` ignores it."}},__svelteCsf:{rawCode:`<div style="height:560px;">
	<VirtualGrid
		{items}
		{sections}
		{tile}
