import{p as Z,f as h,a as w,s as u,b as i,c as ee,d as g,j as x,e as O,k as A,g as C}from"./iframe-CneAOyCj.js";import{c as te,d as ae}from"./create-runtime-stories-DKTrIZX9.js";import{D as k}from"./Drawer-Cm1TdB0F.js";import{B as $}from"./button-B2IJn-W3.js";import{e as T,i as R}from"./attributes-DAgOpy5t.js";import"./preload-helper-PPVm8Dsz.js";import"./this-BEEmHngT.js";import"./clone-D66BMmEo.js";import"./dialog-content-DhFLd5u_.js";import"./create-id-DNrsnDqL.js";import"./index-CFQNpvZu.js";import"./presence-manager.svelte-Bx7wI70O.js";import"./scroll-lock-2ylNfGuQ.js";import"./roving-focus-group-DpN6rdaG.js";import"./shadcn-utils-Chv0K3Z4.js";import"./DragHandle-DnD4OPKc.js";import"./Icon-6JA8irOf.js";import"./transitions-DA1CuYmT.js";import"./x-C3CI7SSd.js";import"./index-BYYM_19d.js";const{expect:t,userEvent:d,waitFor:m,within:S,screen:s}=__STORYBOOK_MODULE_TEST__,ne={title:"Composites/Drawer",component:k,tags:["autodocs"]},{Story:_}=ae();async function y(){await m(()=>t(document.body.style.pointerEvents).not.toBe("none"))}var oe=h('<p data-testid="row"></p>'),re=h("<!> <!>",1),se=h('<p data-testid="row"></p>'),ie=h("<!> <!>",1),le=h('<p data-testid="row"></p>'),de=h("<!> <!>",1),pe=h("<p>One short line.</p>"),ce=h("<!> <!>",1),he=h('<p data-testid="row"></p>'),we=h("<!> <!>",1),ue=h("<!> <!> <!>  <!>  <!>  <!>",1);function j(z,U){Z(U,!0);const N=l=>{var n=re(),e=w(n);$(e,{onclick:()=>g(I,!0),children:(a,p)=>{var o=x("Open drawer");i(a,o)},$$slots:{default:!0}});var r=u(e,2);k(r,{get open(){return C(I)},onOpenChange:a=>g(I,a,!0),title:"Selected item",testId:"demo-drawer",children:(a,p)=>{var o=A(),f=w(o);T(f,16,()=>Array(16),R,(v,H,b)=>{var c=oe();c.textContent=`Row ${b+1} of content — enough rows to push well past peek height.`,i(v,c)}),i(a,o)},$$slots:{default:!0}}),i(l,n)},K=l=>{var n=ie(),e=w(n);$(e,{onclick:()=>g(F,!0),children:(a,p)=>{var o=x("Open drawer");i(a,o)},$$slots:{default:!0}});var r=u(e,2);k(r,{get open(){return C(F)},onOpenChange:a=>g(F,a,!0),title:"Selected item",testId:"default-drawer",children:(a,p)=>{var o=A(),f=w(o);T(f,16,()=>Array(16),R,(v,H,b)=>{var c=se();c.textContent=`Row ${b+1} of content — enough rows to push well past peek height.`,i(v,c)}),i(a,o)},$$slots:{default:!0}}),i(l,n)},Y=l=>{var n=de(),e=w(n);$(e,{onclick:()=>g(P,!0),children:(a,p)=>{var o=x("Open drawer");i(a,o)},$$slots:{default:!0}});var r=u(e,2);k(r,{get open(){return C(P)},onOpenChange:a=>g(P,a,!0),title:"A deliberately long title that wraps across more than one line while the drawer is peeking, to exercise the peek-time clamp — long enough to still wrap even at a wide desktop test viewport, not just a narrow mobile one, since this story runs at whatever width the test harness happens to use",testId:"long-title-drawer",children:(a,p)=>{var o=A(),f=w(o);T(f,16,()=>Array(16),R,(v,H,b)=>{var c=le();c.textContent=`Row ${b+1} of body content below the title.`,i(v,c)}),i(a,o)},$$slots:{default:!0}}),i(l,n)},J=l=>{var n=ce(),e=w(n);$(e,{onclick:()=>g(D,!0),children:(a,p)=>{var o=x("Open drawer");i(a,o)},$$slots:{default:!0}});var r=u(e,2);k(r,{get open(){return C(D)},onOpenChange:a=>g(D,a,!0),title:"Short",testId:"short-drawer",children:(a,p)=>{var o=pe();i(a,o)},$$slots:{default:!0}}),i(l,n)},Q=l=>{var n=we(),e=w(n);$(e,{onclick:()=>g(E,!0),children:(a,p)=>{var o=x("Open drawer");i(a,o)},$$slots:{default:!0}});var r=u(e,2);k(r,{get open(){return C(E)},onOpenChange:a=>g(E,a,!0),title:"Selected item",handleStyle:"bar",testId:"bar-drawer",children:(a,p)=>{var o=A(),f=w(o);T(f,16,()=>Array(16),R,(v,H,b)=>{var c=he();c.textContent=`Row ${b+1} of content — enough rows to push well past peek height.`,i(v,c)}),i(a,o)},$$slots:{default:!0}}),i(l,n)};let I=O(!1),P=O(!1),D=O(!1),E=O(!1),F=O(!0);var V=ue(),q=w(V);_(q,{name:"Default (peek)",get template(){return K},parameters:{docs:{description:{story:`The showcase: OPEN at rest, peeking at the default height — which is what this story was
...
>
	...
	{/each}
</Drawer>`}}});var L=u(W,2);_(L,{name:"Long title clamps while peeking, full when expanded",get template(){return Y},play:async({canvasElement:l})=>{await y();const n=S(l);await d.click(n.getByRole("button",{name:"Open drawer"}));const e=await s.findByTestId("long-title-drawer");await t(e).toBeVisible();const r=e.querySelector(".drawer-title");if(!r)throw new Error("expected .drawer-title to exist");await t(r.textContent?.trim()).toContain("deliberately long title");const a=r.getBoundingClientRect().height,p=s.getByRole("button",{name:/expand/i});await d.click(p),await m(async()=>{await t(e).toHaveAttribute("data-drawer-state","expanded")});const o=r.getBoundingClientRect().height;await t(o).toBeGreaterThan(a),await t(e).toBeVisible(),await t(e).toHaveAttribute("data-drawer-state","expanded")},parameters:{docs:{description:{story:"Interaction test: a long `title` string is visually clamped to one line while peeking (its\nrendered box stays short) and expands to its full, unclamped height once the grip is toggled —\nthe full text is present in the DOM throughout (never sliced), only the visual clamp changes."}},__svelteCsf:{rawCode:`<Button onclick={() => (longTitleOpen = true)}>Open drawer</Button>
<Drawer
	open={longTitleOpen}
...
>
	...
	{/each}
</Drawer>`}}});var M=u(L,2);_(M,{name:"No fade when content already fits",get template(){return J},play:async({canvasElement:l})=>{await y();const n=S(l);await d.click(n.getByRole("button",{name:"Open drawer"}));const e=await s.findByTestId("short-drawer");await t(e).toBeVisible(),await t(e.querySelector(".drawer-fade")).toBeNull();const r=s.getByRole("button",{name:/expand/i});await t(r).toBeDisabled(),await d.click(r),await t(e).toHaveAttribute("data-drawer-state","peek");const a=s.getByRole("button",{name:/close/i});await t(a).not.toBeDisabled(),await t(e).toBeVisible(),await t(e.querySelector(".drawer-fade")).toBeNull()},parameters:{docs:{description:{story:`Interaction test: when content is genuinely short enough to fit within the peek window, no fade
