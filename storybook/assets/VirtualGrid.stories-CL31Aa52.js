import{p as O,f as d,a as G,B as q,h as u,b as l,s as b,c as R,t as K,i as L}from"./iframe-CneAOyCj.js";import{c as N,d as V}from"./create-runtime-stories-DKTrIZX9.js";import{V as v}from"./VirtualGrid-GKJWhB_C.js";import{s as k}from"./attributes-DAgOpy5t.js";import{i as I}from"./lifecycle-RQv-c4Hy.js";import"./preload-helper-PPVm8Dsz.js";import"./this-BEEmHngT.js";import"./scrollMemory-qOkQMXt7.js";import"./shadcn-utils-Chv0K3Z4.js";import"./reducedMotion.svelte-LHpnMWEc.js";const{expect:a,userEvent:h,waitFor:J,within:A,fn:P}=__STORYBOOK_MODULE_TEST__,g=(c,i=q,o=q)=>{var r=H(),p=u(r);K(()=>{k(r,`width:100%;height:100%;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:600;background:hsl(${i().hue??""} 70% 55%)`),L(p,o())}),l(c,r)},x=120,S=20,f=Array.from({length:x},(c,i)=>({id:i,hue:i*47%360})),y=Array.from({length:Math.ceil(x/S)},(c,i)=>{const o=i*S,r=Math.min(o+S,x);return{key:`s${i}`,title:`Section ${i+1}`,subtitle:`${r-o} items`,startIndex:o,endIndex:r,count:r-o}}),$=P(),M={title:"Composites/VirtualGrid",component:v,tags:["autodocs"],parameters:{layout:"fullscreen",a11y:{context:{exclude:[[".tile"]]}}}},{Story:_}=V();var H=d("<div> </div>"),W=d('<div style="height:560px;"><!></div>'),D=d('<div style="height:560px;"><!></div>'),F=d('<div style="height:560px;"><!></div>'),j=d('<div style="height:560px;"><!></div>'),U=d("<!> <!> <!> <!>",1);function B(c,i){O(i,!1),I();var o=U(),r=G(o);_(r,{name:"Justified",asChild:!0,children:(t,n)=>{var e=W(),s=u(e);v(s,{get items(){return f},get sections(){return y},get tile(){return g},ariaLabel:"Justified demo grid",aspect:m=>1+m.id%3*.4}),l(t,e)},$$slots:{default:!0},parameters:{docs:{description:{story:"The grid fills its parent (height:100%), so stories give it a fixed-height box.\n`aspect` varies cell width in the justified layout; `square` ignores it."}},__svelteCsf:{rawCode:`<div style="height:560px;">
	<VirtualGrid
		{items}
		{sections}
		{tile}
